    ...
    <footer className='bg-black pt-16 pb-6 px-5 flex flex-col gap-y-16'>
        <div className='flex flex-col gap-y-16 md:flex-row md:justify-between'>
            <div className='flex flex-col gap-4 items-center md:items-start mx-11 sm:mx-0 md:w-[40%]'>
                ...
                <p className={`text-white text-center md:text-start ${inter.className} text-[14px]/[21px] font-normal`}>
            ...
            <ul className="flex flex-col gap-6">
                <p className={`text-[#666666] text-center ${inter.className} text-[18px]/[18px] font-medium capitalize`}>
                    Quick Links
                </p>
                <li className={`text-white text-center ${inter.className} text-[14px]/[21px] font-normal capitalize`}>
                    Your Problems
                </li>
                <li className={`text-white text-center ${inter.className} text-[14px]/[21px] font-normal capitalize`}>
                    Our Solution
            ...
            <ul className="flex flex-col gap-6">
                ...
                <li className={`text-white text-center ${inter.className} text-[14px]/[21px] font-normal capitalize flex items-center justify-center gap-2`}>
                    <span>
