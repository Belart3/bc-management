...
const PricingSection = () => {
  return (
        <div className="flex flex-col gap-4 sm:gap-x-[1%] sm:flex-row sm:flex-wrap w-full max-w-[700px] lg:max-w-[1300px] lg:gap-0 lg:justify-between mx-auto">
          ...
          <div className="p-5 bg-white flex flex-col gap-6 rounded-lg w-full md:w-[49%] lg:w-[32%] border border-[#CCCCCC] mx-auto max-w-[400px]">
          ...
          <div className="rounded-[12px] bg-[#F4844C4D] p-[6px] w-full md:w-[49%]  lg:w-[32%] mx-auto max-w-[400px]">
            <div className="p-5 bg-[#F4844C] flex flex-col gap-6 rounded-lg h-full">
              <div className="gap-6 flex flex-col border-b pb-6 border-[#CCC]">
              ...
              <ul className="flex flex-col gap-3 items-start w-full">
                ...
                <li className={`text-white ${inter.className} text-[16px]/[24px] font-normal text-start capitalize list-disc ms-5`}>
                  Up to 1,000 transactions per fiscal year
                </li>
                <li className={`text-white ${inter.className} text-[16px]/[24px] font-normal text-start capitalize list-disc ms-5`}>
                  yearly summary report
                </li>
          ...
          <div className="p-5 bg-white flex flex-col gap-6 rounded-lg w-full md:w-[49%] lg:w-[32%] border border-[#CCCCCC] max-w-[400px] mx-auto">
            <div className="gap-6 flex flex-col border-b pb-6 border-[#CCC]">
              <p className={`${inter.className} text-black text-start text-[18px]/[18px] font-medium capitalize`}>
                advanced
              </p>
          ...
          <div className="flex flex-col lg:flex-row rounded-lg lg:rounded-lg border border-[#333333]  bg-black my-0 lg:mb-[64px] gap-10 order-4 lg:order-4 lg:mt-4 justify-start lg:justify-center lg:items-center w-full  sm:w-[70%] md:w-[49%] lg:min-w-[400px] lg:w-full mx-auto lg:mx-0 relative z-10 overflow-hidden
